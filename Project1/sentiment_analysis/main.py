...
os.chdir('/Users/shera/VSCode/ML_project/Project1/sentiment_analysis')
...
#    p1.classifier_accuracy(p1.perceptron, train_bow_features,test_bow_features,train_labels,test_labels,T=50)

# print("{:35} {:.4f}".format("Validation accuracy for perceptron:", pct_test_accuracy))

# avg_pct_train_accuracy, avg_pct_test_accuracy = \
#    p1.classifier_accuracy(p1.average_perceptron, train_bow_features,test_bow_features,train_labels,test_labels,T=10)
...
best_theta = p1.pegasos(test_bow_features, test_labels, T=25, L=0.01)[0]
